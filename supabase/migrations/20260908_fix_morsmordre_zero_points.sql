-- Morsmordre must respect the existing nonnegative student score constraint.
-- Keep the house penalty even when the selected student already has zero points.
...
begin
  ...
  loop
    ...
    update hechi.alumnos
    set puntos = greatest(0, puntos - 1),
        updated_at = now()
